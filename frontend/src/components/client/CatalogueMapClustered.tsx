...
// Custom green icon for candidates
...
interface CatalogueMapClusteredProps {
  catalogueId: string;
  onCityClick?: (city: string, count: number) => void;
}

const CatalogueMapClustered: React.FC<CatalogueMapClusteredProps> = ({ catalogueId, onCityClick }) => {
              ...
              >
                <Popup>
                  <Box>
                    ...
                    <Chip
                      label={`${stat.count} candidat${stat.count > 1 ? 's' : ''} disponible${stat.count > 1 ? 's' : ''}`}
                      color="success"
                      size="small"
                      sx={{ mb: 1 }}
                    />
...
export default CatalogueMapClustered;

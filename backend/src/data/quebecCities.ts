// Seed statique de coordonnées de villes (résolution instantanée, sans appel
// externe). Copié du front (frontend/src/utils/quebecCities.ts). Les villes
// absentes d'ici sont géocodées à la demande (cityGeocode.service.ts).
